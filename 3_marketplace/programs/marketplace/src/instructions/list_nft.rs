...
pub struct ListNft<'info> {
    ...
    /// The collection mint that this NFT belongs to (optional)
    /// - Used for collection verification
    /// - Can be the same as the NFT mint for non-collection NFTs
    pub collection_mint: InterfaceAccount<'info, Mint>,

    /// The metadata account for the NFT
    /// - Contains collection information and verification status
    /// - Collection is optional (can be None for non-collection NFTs)
    #[account(
        seeds = [
            b"metadata",
