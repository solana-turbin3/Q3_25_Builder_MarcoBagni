...
impl<'info> Stake<'info> {
    ...
    pub fn stake(&mut self, bumps: StakeBumps, amount: u8) -> Result<()> {
        let clock = Clock::get()?;
        ...
        self.user_account.amount_staked = self.user_account.amount_staked.saturating_add(amount);
        ...
        transfer(cpi_ctx, amount as u64)?; // Transfer the specified amount
